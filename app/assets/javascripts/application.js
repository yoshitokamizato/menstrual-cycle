...
var two_week_ago = new Date(today.getFullYear(), today.getMonth(), today.getDate() - 13);
var a_month_ago = new Date(today.getFullYear(), today.getMonth() - 1, today.getDate());
var three_month_ago = new Date(today.getFullYear(), today.getMonth() - 3, today.getDate());
...
function onButtonClickTwoWeek() {
    onButtonClickPast(two_week_ago);
}
...
function onButtonClickThreeMonth() {
    onButtonClickPast(three_month_ago);
}
